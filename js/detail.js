...
function echartsData(){
    ...
    var myChart = echarts.init(document.getElementById('echarts-data'));
    option = {
        color:['#dedede'],  //主体颜色
        legend: {
            data:['价格走势']       
        ...
        xAxis: {
            ...
            // max:'02/22',
            // min:'01/27',
            data: ['01/27', '01/30', '01/31', '02/11', '02/13', '02/14', '02/18', '02/22']
        },
        yAxis: {
            type: 'value',
            // max:6100,
        ...
        series: [
            {
                name: '价格走势',
                // type: 'bar',
                data: [5960, 5989, 6009, 5999, 6060, 6099, 6099, 6099],
                type: 'line',
                areaStyle: {}
            }
        ],
...
var banData = (function () {
    ...
    function firstScreen() {
        ...
        $('.product').html(pro);
        $('.product .pro-option').on('tap',function(){
            $('#echarts-data').show();
            echartsData();
            console.log(1);
        })
...
; var shops = (function () {
    ...
    function shopColor() {
        $('.shops-module-color a').on('tap', function () {
            ...
            $('.shops-color .color').html($('.shops-module-color a.active').html());
            $('.shop-selected .color').html($('.shops-module-color a.active').html());
            $('.shop-selected').data("color",$('.shops-module-color a.active').html());
        })
    }
    //容量
    function shopMemory() {
        $('.shops-module-memory a').on('tap', function () {
            console.log($('.shops-module-memory a.active').html());
            ...
            $('.shops-color .memory').html($('.shops-module-memory a.active').html());
            $('.shop-selected  .memory').html($('.shops-module-memory a.active').html());
            $('.shop-selected').data("memory",$('.shops-module-memory a.active').html());
        })
    }
    // 版本
    function shopVsn() {
        ...
        $('.shops-module-versions a').on('tap', function () {
            $('.shop-selected').data("versions",$('.shops-module-versions a.active').html());
